...
const baseSchema = zod_1.z.object({
    ...
    qty: zod_1.z.number().default(0).nullish(),
}).strict();
const relationSchema = zod_1.z.object({
    variant: zod_1.z.record(zod_1.z.unknown()),
    entry: zod_1.z.array(zod_1.z.unknown()).optional(),
...
exports.ItemPrismaUpdateSchema = zod_1.z.object({
    ...
    updatedAt: zod_1.z.coerce.date(),
    size: zod_1.z.string().nullish(),
    qty: zod_1.z.union([zod_1.z.number().default(0).nullish(), zod_1.z.record(zod_1.z.unknown())])
}).partial().passthrough();
/**
 * `Item` schema for create operations excluding foreign keys and relations.
 */
exports.ItemCreateScalarSchema = baseSchema.partial({
    id: true, createdAt: true, updatedAt: true, qty: true
});
/**
