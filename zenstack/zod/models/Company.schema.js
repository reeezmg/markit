...
const baseSchema = zod_1.z.object({
    ...
    isBarcodeIncluded: zod_1.z.boolean().default(true),
...
const relationSchema = zod_1.z.object({
    ...
    promoCodes: zod_1.z.array(zod_1.z.unknown()).optional(),
    ...
    carts: zod_1.z.array(zod_1.z.unknown()).optional(),
    ...
    likeCompanies: zod_1.z.array(zod_1.z.unknown()).optional(),
    productinput: zod_1.z.record(zod_1.z.unknown()).optional(),
    variantinput: zod_1.z.record(zod_1.z.unknown()).optional(),
});
/**
...
exports.CompanyCreateScalarSchema = baseSchema.partial({
    id: true, storecode: true, isTaxIncluded: true, isBarcodeIncluded: true, status: true, billCounter: true, barcodeCounter: true
});
/**
