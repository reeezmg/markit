...
const policy = {
    policy: { distributorCompany: {
        ...
        productinput: {
            modelLevel: { read: { guard: Productinput_read, },
                create: { guard: Productinput_create, inputChecker: Productinput_create_input, },
                update: { guard: Productinput_update, },
                postUpdate: { guard: Productinput_postUpdate, },
                delete: { guard: Productinput_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        variantinput: {
            modelLevel: { read: { guard: Variantinput_read, },
                create: { guard: Variantinput_create, inputChecker: Variantinput_create_input, },
                update: { guard: Variantinput_update, },
                postUpdate: { guard: Variantinput_postUpdate, },
                delete: { guard: Variantinput_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        ...
        distributorPayment: {
            modelLevel: { read: { guard: DistributorPayment_read, },
                create: { guard: DistributorPayment_create, inputChecker: DistributorPayment_create_input, },
                update: { guard: DistributorPayment_update, },
                postUpdate: { guard: DistributorPayment_postUpdate, },
                delete: { guard: DistributorPayment_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        distributorCredit: {
            modelLevel: { read: { guard: DistributorCredit_read, },
                create: { guard: DistributorCredit_create, inputChecker: DistributorCredit_create_input, },
                update: { guard: DistributorCredit_update, },
                postUpdate: { guard: DistributorCredit_postUpdate, },
                delete: { guard: DistributorCredit_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        ...
        billHistory: {
            modelLevel: { read: { guard: BillHistory_read, },
                create: { guard: BillHistory_create, inputChecker: BillHistory_create_input, },
                update: { guard: BillHistory_update, },
                postUpdate: { guard: BillHistory_postUpdate, },
                delete: { guard: BillHistory_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        ...
        promoCode: {
            modelLevel: { read: { guard: PromoCode_read, },
                create: { guard: PromoCode_create, inputChecker: PromoCode_create_input, },
                update: { guard: PromoCode_update, },
                postUpdate: { guard: PromoCode_postUpdate, },
                delete: { guard: PromoCode_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        clientPromoCode: {
            modelLevel: { read: { guard: ClientPromoCode_read, },
                create: { guard: ClientPromoCode_create, inputChecker: ClientPromoCode_create_input, },
                update: { guard: ClientPromoCode_update, },
                postUpdate: { guard: ClientPromoCode_postUpdate, },
                delete: { guard: ClientPromoCode_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        cart: {
            modelLevel: { read: { guard: Cart_read, },
        ...
        cartCompanyClient: {
            modelLevel: { read: { guard: CartCompanyClient_read, },
                create: { guard: CartCompanyClient_create, inputChecker: CartCompanyClient_create_input, },
                update: { guard: CartCompanyClient_update, },
                postUpdate: { guard: CartCompanyClient_postUpdate, },
                delete: { guard: CartCompanyClient_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        like: {
            modelLevel: { read: { guard: Like_read, },
                create: { guard: Like_create, inputChecker: Like_create_input, },
                update: { guard: Like_update, },
                postUpdate: { guard: Like_postUpdate, },
                delete: { guard: Like_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
        likeCompanyClient: {
            modelLevel: { read: { guard: LikeCompanyClient_read, },
                create: { guard: LikeCompanyClient_create, inputChecker: LikeCompanyClient_create_input, },
                update: { guard: LikeCompanyClient_update, },
                postUpdate: { guard: LikeCompanyClient_postUpdate, },
                delete: { guard: LikeCompanyClient_delete, } },
            fieldLevel: { read: {},
                update: {},
            },
        },
    },
    validation: { distributorCompany: { hasValidation: false },
        company: { hasValidation: false },
        productinput: { hasValidation: false },
        variantinput: { hasValidation: false },
        distributor: { hasValidation: false },
        purchaseOrder: { hasValidation: false },
        distributorPayment: { hasValidation: false },
        distributorCredit: { hasValidation: false },
        ...
        promoCode: { hasValidation: false },
        clientPromoCode: { hasValidation: false },
        cart: { hasValidation: false },
        cartCompanyClient: { hasValidation: false },
        like: { hasValidation: false },
        likeCompanyClient: { hasValidation: false },
    },
...
function Productinput_read(context, db) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return { AND: [] };
...
function $check_Productinput_read(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Productinput_create(context, db) {
    return { OR: [] };
}
function $check_Productinput_create(input, context) {
    return false;
}
function Productinput_create_input(input, context) {
    return false;
}
function Productinput_update(context, db) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return { AND: [] };
...
function $check_Productinput_update(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Productinput_postUpdate(context, db) {
    return { AND: [] };
}
function $check_Productinput_postUpdate(input, context) {
    return true;
}
function Productinput_delete(context, db) {
    return { OR: [] };
}
function $check_Productinput_delete(input, context) {
    return false;
}
function Variantinput_read(context, db) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return { AND: [] };
...
function $check_Variantinput_read(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Variantinput_create(context, db) {
    return { OR: [] };
}
function $check_Variantinput_create(input, context) {
    return false;
}
function Variantinput_create_input(input, context) {
    return false;
}
function Variantinput_update(context, db) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return { AND: [] };
...
function $check_Variantinput_update(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Variantinput_postUpdate(context, db) {
    return { AND: [] };
}
function $check_Variantinput_postUpdate(input, context) {
    return true;
}
function Variantinput_delete(context, db) {
    return { OR: [] };
}
function $check_Variantinput_delete(input, context) {
    return false;
}
...
function DistributorPayment_read(context, db) {
    return { AND: [] };
}
function $check_DistributorPayment_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorPayment_create(context, db) {
    return { AND: [] };
}
function $check_DistributorPayment_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorPayment_create_input(input, context) {
    return true;
}
function DistributorPayment_update(context, db) {
    return { AND: [] };
}
function $check_DistributorPayment_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorPayment_postUpdate(context, db) {
    return { AND: [] };
}
function $check_DistributorPayment_postUpdate(input, context) {
    return true;
}
function DistributorPayment_delete(context, db) {
    return { AND: [] };
}
function $check_DistributorPayment_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorCredit_read(context, db) {
    return { AND: [] };
}
function $check_DistributorCredit_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorCredit_create(context, db) {
    return { AND: [] };
}
function $check_DistributorCredit_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorCredit_create_input(input, context) {
    return true;
}
function DistributorCredit_update(context, db) {
    return { AND: [] };
}
function $check_DistributorCredit_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function DistributorCredit_postUpdate(context, db) {
    return { AND: [] };
}
function $check_DistributorCredit_postUpdate(input, context) {
    return true;
}
function DistributorCredit_delete(context, db) {
    return { AND: [] };
}
function $check_DistributorCredit_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
...
function BillHistory_read(context, db) {
    return { AND: [] };
}
function $check_BillHistory_read(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function BillHistory_create(context, db) {
    return { AND: [] };
}
function $check_BillHistory_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function BillHistory_create_input(input, context) {
    return true;
}
function BillHistory_update(context, db) {
    return { AND: [] };
}
function $check_BillHistory_update(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function BillHistory_postUpdate(context, db) {
    return { AND: [] };
}
function $check_BillHistory_postUpdate(input, context) {
    return true;
}
function BillHistory_delete(context, db) {
    return { AND: [] };
}
function $check_BillHistory_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
...
function PromoCode_read(context, db) {
    return { AND: [] };
}
function $check_PromoCode_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function PromoCode_create(context, db) {
    return { AND: [] };
}
function $check_PromoCode_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function PromoCode_create_input(input, context) {
    return true;
}
function PromoCode_update(context, db) {
    return { AND: [] };
}
function $check_PromoCode_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function PromoCode_postUpdate(context, db) {
    return { AND: [] };
}
function $check_PromoCode_postUpdate(input, context) {
    return true;
}
function PromoCode_delete(context, db) {
    return { AND: [] };
}
function $check_PromoCode_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function ClientPromoCode_read(context, db) {
    return { AND: [] };
}
function $check_ClientPromoCode_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function ClientPromoCode_create(context, db) {
    return { AND: [] };
}
function $check_ClientPromoCode_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function ClientPromoCode_create_input(input, context) {
    return true;
}
function ClientPromoCode_update(context, db) {
    return { AND: [] };
}
function $check_ClientPromoCode_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function ClientPromoCode_postUpdate(context, db) {
    return { AND: [] };
}
function $check_ClientPromoCode_postUpdate(input, context) {
    return true;
}
function ClientPromoCode_delete(context, db) {
    return { AND: [] };
}
function $check_ClientPromoCode_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function Cart_read(context, db) {
    return { AND: [] };
}
function $check_Cart_read(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Cart_create(context, db) {
    return { AND: [] };
}
function $check_Cart_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function Cart_create_input(input, context) {
    return true;
}
function Cart_update(context, db) {
    return { AND: [] };
}
function $check_Cart_update(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Cart_postUpdate(context, db) {
    return { AND: [] };
}
function $check_Cart_postUpdate(input, context) {
    return true;
}
function Cart_delete(context, db) {
    return { AND: [] };
}
function $check_Cart_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function CartCompanyClient_read(context, db) {
    return { AND: [] };
}
function $check_CartCompanyClient_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function CartCompanyClient_create(context, db) {
    return { AND: [] };
}
function $check_CartCompanyClient_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function CartCompanyClient_create_input(input, context) {
    return true;
}
function CartCompanyClient_update(context, db) {
    return { AND: [] };
}
function $check_CartCompanyClient_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function CartCompanyClient_postUpdate(context, db) {
    return { AND: [] };
}
function $check_CartCompanyClient_postUpdate(input, context) {
    return true;
}
function CartCompanyClient_delete(context, db) {
    return { AND: [] };
}
function $check_CartCompanyClient_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function Like_read(context, db) {
    return { AND: [] };
}
function $check_Like_read(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Like_create(context, db) {
    return { AND: [] };
}
function $check_Like_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function Like_create_input(input, context) {
    return true;
}
function Like_update(context, db) {
    return { AND: [] };
}
function $check_Like_update(input, context) {
    var _a;
    const user = (_a = context.user) !== null && _a !== void 0 ? _a : null;
    if (((user === null || user === void 0 ? void 0 : user.role) == 'admin')) {
        return true;
...
function Like_postUpdate(context, db) {
    return { AND: [] };
}
function $check_Like_postUpdate(input, context) {
    return true;
}
function Like_delete(context, db) {
    return { AND: [] };
}
function $check_Like_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function LikeCompanyClient_read(context, db) {
    return { AND: [] };
}
function $check_LikeCompanyClient_read(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function LikeCompanyClient_create(context, db) {
    return { AND: [] };
}
function $check_LikeCompanyClient_create(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function LikeCompanyClient_create_input(input, context) {
    return true;
}
function LikeCompanyClient_update(context, db) {
    return { AND: [] };
}
function $check_LikeCompanyClient_update(input, context) {
    if (true) {
        return true;
    }
    return false;
}
function LikeCompanyClient_postUpdate(context, db) {
    return { AND: [] };
}
function $check_LikeCompanyClient_postUpdate(input, context) {
    return true;
}
function LikeCompanyClient_delete(context, db) {
    return { AND: [] };
}
function $check_LikeCompanyClient_delete(input, context) {
    if (true) {
        return true;
    }
    return false;
