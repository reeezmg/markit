...
export function useCheckBill<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; invoiceNumber?: string; paymentMethod?: string; redeemedPoints?: number; billPoints?: number; paymentStatus?: PaymentStatus; transactionId?: string; notes?: string; type?: OrderType; status?: OrderStatus; deleted?: boolean; returnDeadline?: string; companyId?: string; accountId?: string; clientId?: string; userId?: string; addressId?: string }; }, options?: (MaybeRefOrGetter<Omit<UnwrapRef<UseQueryOptions<boolean, TError, boolean>>, 'queryKey'>> | ComputedRef<Omit<UnwrapRef<UseQueryOptions<boolean, TError, boolean>>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
