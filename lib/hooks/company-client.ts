/* eslint-disable */
import type { Prisma, CompanyClient } from "@prisma/client";
...
export function useFindManyCompanyClient<TArgs extends Prisma.CompanyClientFindManyArgs, TQueryFnData = Array<Prisma.CompanyClientGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('CompanyClient', `${endpoint}/companyClient/findMany`, args, options, fetch);
}

export function useInfiniteFindManyCompanyClient<TArgs extends Prisma.CompanyClientFindManyArgs, TQueryFnData = Array<Prisma.CompanyClientGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
    return useInfiniteModelQuery<TQueryFnData, TData, TError>('CompanyClient', `${endpoint}/companyClient/findMany`, args, options, fetch);
}

export function useFindUniqueCompanyClient<TArgs extends Prisma.CompanyClientFindUniqueArgs, TQueryFnData = Prisma.CompanyClientGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindUniqueArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindUniqueArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('CompanyClient', `${endpoint}/companyClient/findUnique`, args, options, fetch);
}

export function useFindFirstCompanyClient<TArgs extends Prisma.CompanyClientFindFirstArgs, TQueryFnData = Prisma.CompanyClientGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindFirstArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientFindFirstArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateCompanyClient<TArgs extends Prisma.CompanyClientAggregateArgs, TQueryFnData = Prisma.GetCompanyClientAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useCountCompanyClient<TArgs extends Prisma.CompanyClientCountArgs, TQueryFnData = TArgs extends { select: any; } ? TArgs['select'] extends true ? number : Prisma.GetScalarType<TArgs['select'], Prisma.CompanyClientCountAggregateOutputType> : number, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.CompanyClientCountArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.CompanyClientCountArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('CompanyClient', `${endpoint}/companyClient/count`, args, options, fetch);
}

export function useCheckCompanyClient<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { companyId?: string; clientId?: string }; }, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
