...
export function useCheckEntry<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; name?: string; barcode?: string; size?: string; userName?: string; companyId?: string; userId?: string; variantId?: string; outOfStock?: boolean; categoryId?: string; billId?: string; itemId?: string; return?: boolean }; }, options?: (MaybeRefOrGetter<Omit<UnwrapRef<UseQueryOptions<boolean, TError, boolean>>, 'queryKey'>> | ComputedRef<Omit<UnwrapRef<UseQueryOptions<boolean, TError, boolean>>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
