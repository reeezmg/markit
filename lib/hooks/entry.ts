...
export function useFindManyEntry<TArgs extends Prisma.EntryFindManyArgs, TQueryFnData = Array<Prisma.EntryGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.EntryFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.EntryFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Entry', `${endpoint}/entry/findMany`, args, options, fetch);
}

export function useInfiniteFindManyEntry<TArgs extends Prisma.EntryFindManyArgs, TQueryFnData = Array<Prisma.EntryGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.EntryFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.EntryFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
    return useInfiniteModelQuery<TQueryFnData, TData, TError>('Entry', `${endpoint}/entry/findMany`, args, options, fetch);
}

export function useFindUniqueEntry<TArgs extends Prisma.EntryFindUniqueArgs, TQueryFnData = Prisma.EntryGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.EntryFindUniqueArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.EntryFindUniqueArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateEntry<TArgs extends Prisma.EntryAggregateArgs, TQueryFnData = Prisma.GetEntryAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.EntryAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.EntryAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
