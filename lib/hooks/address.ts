...
export function useFindManyAddress<TArgs extends Prisma.AddressFindManyArgs, TQueryFnData = Array<Prisma.AddressGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.AddressFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.AddressFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Address', `${endpoint}/address/findMany`, args, options, fetch);
}

export function useInfiniteFindManyAddress<TArgs extends Prisma.AddressFindManyArgs, TQueryFnData = Array<Prisma.AddressGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.AddressFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.AddressFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
    return useInfiniteModelQuery<TQueryFnData, TData, TError>('Address', `${endpoint}/address/findMany`, args, options, fetch);
}

export function useFindUniqueAddress<TArgs extends Prisma.AddressFindUniqueArgs, TQueryFnData = Prisma.AddressGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.AddressFindUniqueArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.AddressFindUniqueArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateAddress<TArgs extends Prisma.AddressAggregateArgs, TQueryFnData = Prisma.GetAddressAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.AddressAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.AddressAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
