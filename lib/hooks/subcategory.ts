...
export function useFindManySubcategory<TArgs extends Prisma.SubcategoryFindManyArgs, TQueryFnData = Array<Prisma.SubcategoryGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Subcategory', `${endpoint}/subcategory/findMany`, args, options, fetch);
}

export function useInfiniteFindManySubcategory<TArgs extends Prisma.SubcategoryFindManyArgs, TQueryFnData = Array<Prisma.SubcategoryGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
    return useInfiniteModelQuery<TQueryFnData, TData, TError>('Subcategory', `${endpoint}/subcategory/findMany`, args, options, fetch);
}

export function useFindUniqueSubcategory<TArgs extends Prisma.SubcategoryFindUniqueArgs, TQueryFnData = Prisma.SubcategoryGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindUniqueArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindUniqueArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Subcategory', `${endpoint}/subcategory/findUnique`, args, options, fetch);
}

export function useFindFirstSubcategory<TArgs extends Prisma.SubcategoryFindFirstArgs, TQueryFnData = Prisma.SubcategoryGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindFirstArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.SubcategoryFindFirstArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateSubcategory<TArgs extends Prisma.SubcategoryAggregateArgs, TQueryFnData = Prisma.GetSubcategoryAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.SubcategoryAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.SubcategoryAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
