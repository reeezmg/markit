...
export function useFindManyClient<TArgs extends Prisma.ClientFindManyArgs, TQueryFnData = Array<Prisma.ClientGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.ClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.ClientFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('Client', `${endpoint}/client/findMany`, args, options, fetch);
}

export function useInfiniteFindManyClient<TArgs extends Prisma.ClientFindManyArgs, TQueryFnData = Array<Prisma.ClientGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.ClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.ClientFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
...
export function useFindFirstClient<TArgs extends Prisma.ClientFindFirstArgs, TQueryFnData = Prisma.ClientGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.ClientFindFirstArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.ClientFindFirstArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateClient<TArgs extends Prisma.ClientAggregateArgs, TQueryFnData = Prisma.GetClientAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.ClientAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.ClientAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
