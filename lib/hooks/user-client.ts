...
export function useFindManyUserClient<TArgs extends Prisma.UserClientFindManyArgs, TQueryFnData = Array<Prisma.UserClientGetPayload<TArgs> & { $optimistic?: boolean }>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientFindManyArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('UserClient', `${endpoint}/userClient/findMany`, args, options, fetch);
}

export function useInfiniteFindManyUserClient<TArgs extends Prisma.UserClientFindManyArgs, TQueryFnData = Array<Prisma.UserClientGetPayload<TArgs>>, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientFindManyArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientFindManyArgs>>, options?: MaybeRefOrGetter<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>>) {
    const { endpoint, fetch } = getHooksContext();
    return useInfiniteModelQuery<TQueryFnData, TData, TError>('UserClient', `${endpoint}/userClient/findMany`, args, options, fetch);
}

export function useFindUniqueUserClient<TArgs extends Prisma.UserClientFindUniqueArgs, TQueryFnData = Prisma.UserClientGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientFindUniqueArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientFindUniqueArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('UserClient', `${endpoint}/userClient/findUnique`, args, options, fetch);
}

export function useFindFirstUserClient<TArgs extends Prisma.UserClientFindFirstArgs, TQueryFnData = Prisma.UserClientGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientFindFirstArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientFindFirstArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useAggregateUserClient<TArgs extends Prisma.UserClientAggregateArgs, TQueryFnData = Prisma.GetUserClientAggregateType<TArgs>, TData = TQueryFnData, TError = DefaultError>(args: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientAggregateArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientAggregateArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
...
export function useCountUserClient<TArgs extends Prisma.UserClientCountArgs, TQueryFnData = TArgs extends { select: any; } ? TArgs['select'] extends true ? number : Prisma.GetScalarType<TArgs['select'], Prisma.UserClientCountAggregateOutputType> : number, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.UserClientCountArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.UserClientCountArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
    return useModelQuery<TQueryFnData, TData, TError>('UserClient', `${endpoint}/userClient/count`, args, options, fetch);
}

export function useCheckUserClient<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { clientId?: string; userId?: string }; }, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
