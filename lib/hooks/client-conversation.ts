...
export function useFindFirstClientConversation<TArgs extends Prisma.ClientConversationFindFirstArgs, TQueryFnData = Prisma.ClientConversationGetPayload<TArgs> & { $optimistic?: boolean }, TData = TQueryFnData, TError = DefaultError>(args?: MaybeRefOrGetter<Prisma.SelectSubset<TArgs, Prisma.ClientConversationFindFirstArgs>> | ComputedRef<Prisma.SelectSubset<TArgs, Prisma.ClientConversationFindFirstArgs>>, options?: (MaybeRefOrGetter<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> | ComputedRef<Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'queryKey'>> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
